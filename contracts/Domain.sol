        ...
        string memory json = Base64.encode(
            bytes(
                ...
                abi.encodePacked(
                    '{"name": "',
                    _name,
                    '", "description": "A domain on the Dope Goat name service", "image": "data:image/svg+xml;base64,',
